    ...
    */
    class civ_car {
        ...
        vehicles[] = {
			...
			{ "A3L_VolksWagenGolfGTiBlack", "" },
			{ "A3L_VolksWagenGolfGTiWhite", "" },
			{ "A3L_VolksWagenGolfGTired", "" },
			{ "A3L_VolksWagenGolfGTiblue", "" },
			{ "A3L_EscortBlue", "" },
			{ "A3L_EscortWhite", "" },
			{ "A3L_EscortBlack", "" },
			{ "A3L_EscortTaxi", "" },
    ...
    class civ_truck {
        ...
        vehicles[] = {
            ...
            { "cg_raptor_truck_va_orange", "" },
            { "cg_raptor_truck_va_grise", "" },
            { "cg_raptor_truck_va_noir", "" },
            { "cg_raptor_truck_va_bleufonce", "" },
            { "cg_raptor_truck_va_rose", "" },
            { "cg_raptor_truck_va_rouge", "" },
            { "cg_raptor_truck_va_bleu", "" },
            { "cg_raptor_truck_va_white", "" },
            { "cg_raptor_truck_va_violet", "" },
			{ "cg_raptor_truck_va_vert", "" },
            { "cg_raptor_truck_va_jaune", "" },
            { "cg_man_tgx_truck_jaune", "" },
            { "cg_man_tgx_truck_orange", "" },
            { "cg_man_tgx_truck_grise", "" },
            { "cg_man_tgx_truck_bleufonce", "" },
            { "cg_man_tgx_truck_noir", "" },
            { "cg_man_tgx_truck_white", "" },
            { "cg_man_tgx_truck_bleu", "" },
            { "cg_man_tgx_truck_rouge", "" },
			{ "cg_man_tgx_truck_vert", "" },
            { "cg_man_tgx_truck_rose", "" },
            { "cg_man_tgx_truck_violet", "" },
            { "cg_daf_xf_euro6_white", "" },
            { "cg_daf_xf_euro6", "" }
        };
    };
...
*/
	...
	class DAR_ChargerPoliceStateSlick {
        vItemSpace = 60;
        conditions = "";
        price = 100;
        textures[] = {};
	...
	class critgamin_smart_bleufonce {
        vItemSpace = 25;
        conditions = "";
        price = 12000;
        textures[] = {};
	...
	class A3L_VolksWagenGolfGTiblue {
        vItemSpace = 35;
        conditions = "";
        price = 26415;
        textures[] = {};
	...
	class cg_raptor_truck_bleufonce {
        vItemSpace = 60;
        conditions = "";
        price = 52000;
        textures[] = {};
	...
	class cg_raptor_truck_va_white {
        vItemSpace = 45;
        conditions = "";
        price = 58000;
        textures[] = {};
	...
	class cg_raptor_truck_va_violet {
        vItemSpace = 45;
        conditions = "";
        price = 58000;
        textures[] = {};
	...
	class cg_raptor_truck_va_jaune {
        vItemSpace = 45;
        conditions = "";
        price = 58000;
        textures[] = {};
	...
	class cg_man_tgx_truck_bleufonce {
        vItemSpace = 150;
        conditions = "";
        price = 90000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_WhiteMatte {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_Purple {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_RedMatte {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_DarkBlueMatte {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_PurpleMatte {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
	...
	class A3L_Jeep_Cherokee_DarkBlue {
        vItemSpace = 42;
        conditions = "";
        price = 24000;
        textures[] = {};
